...
data = pd.read_csv(r'dnbg1982/oil-gas-projects/main/API_Oil_Production/Notebooks/Oil_prod_curve.csv')
...
def forecast():
    ...
    model = pickle.load(open(r'dnbg1982/oil-gas-projects/main/API_Oil_Production/Notebooks/Oil_pred.pkl','rb'))
